...
const EducationSideBySidyView2 = ({
  editMood,
  removeTopic,
    ...
    <div>
      {educationMainArray.map((item, i) => (
        <div id={item.id} key={i} style={{ marginTop: "15px" }}>
          ...
          >
            <div id={item.institute.id} style={{ flex: 3 }}>
              {item.institute.show ? (
                <>
            ...
            {item.passingYear.passingYear ? (
              <>
                <div id={item.passingYear.id} style={{ flex: 1 }}>
          ...
          >
            {item.degree.degree ? (
              <>
                <div
                  id={item.degree.id}
                  style={{ flex: 1, textAlign: "left", position: "relative" }}
                >
                  {item.degree.show ? (
                    <>
                      <div>
...
export default EducationSideBySidyView2;
